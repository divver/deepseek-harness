...
十一态工作流、投递协议、超时与配置键由[包 README](../../packages/coop/coop/README.zh.md) 拥有；评审后的设计决策见 [dsh-coop Agent Note](../../.agents/notes/implemented/architecture/2026-08-22-dsh-coop-shared-file-authority.zh.md)。
