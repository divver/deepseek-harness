...
Source: [`packages/coop/coop/src/types.ts:165`](../packages/coop/coop/src/types.ts)
...
Source: [`packages/coop/coop/src/types.ts:163`](../packages/coop/coop/src/types.ts)
...
Sources: [`packages/coop/coop/src/types.ts:124`](../packages/coop/coop/src/types.ts)

| Property | Presence | Type |
|---|---|---|
| `phase` | required | [`union (2 variants)`](#persistence-type-sha256-b7f63488fe977eddc6cbe285d93f7b063e196b2ede630dff9c1b0007d3f2c0e2) |
...
Sources: [`packages/coop/coop/src/types.ts:108`](../packages/coop/coop/src/types.ts)

| Property | Presence | Type |
|---|---|---|
| `op` | required | [`union (5 variants)`](#persistence-type-sha256-8f85febc2614dec88a92b7f786f83ba0ec6f870c8cedc1b66bb0c29c11d6c6b4) |
| `planId` | required | `string` |
| `status` | required | [`PlanStatus`](#persistence-type-sha256-0b50ca579946b3677ee61c0ba8fd14f545cb59b2a08cea846ce5e70bd1abf253) |
| `summary` | optional | `string` |
...
Sources: [`packages/coop/coop/src/types.ts:101`](../packages/coop/coop/src/types.ts)

| Property | Presence | Type |
|---|---|---|
| `reviewLevel` | optional | [`union (3 variants)`](#persistence-type-sha256-a6dc0a13b012c283981a0ed5996fd486a49c370039e7d306a1e0d5cb12683a8c) |
| `roles` | required | [`Role[]`](#persistence-type-sha256-902d2e51947317ae48232d45be17867b7098a0eead1b9c657ae05eb6c3316dcb) |
...
Sources: [`packages/coop/coop/src/types.ts:116`](../packages/coop/coop/src/types.ts)

| Property | Presence | Type |
|---|---|---|
| `decision` | required | [`union (3 variants)`](#persistence-type-sha256-f4f9652ac7feb59eba1b029733edf740448ac36ef1247b002fbd84fd245ffec5) |
...
Sources: [`packages/coop/coop/src/types.ts:224`](../packages/coop/coop/src/types.ts)
...
| `source` | required | [`MessageSource`](#persistence-type-sha256-5dc06ad185ca3db514838e6551009e85c1e9a44fc1f2140531c82305b1c67941) |
...
| `coop` | `"catalog"` | none | [`{ kind: "coop", form: "catalog" }`](#persistence-type-sha256-25fb34a6187bc3c5e949d6407f197491557dc604524cfee2f65882f8a8dfcb40) |
| `coop` | `"instructions"` | none | [`{ kind: "coop", form: "instructions" }`](#persistence-type-sha256-452c7b32dca56aee91568f07188a22708ec48dd62bb8f99a6510d9db82863859) |
...
| `coop` | `"recall"` | none | [`{ kind: "coop", form: "recall" }`](#persistence-type-sha256-4eef392b53e0dac85cca936fa407598d1da9b0142b0b760bb2fafe0f1b035e32) |
| `coop` | `"relay"` | none | [`{ kind: "coop", form: "relay" }`](#persistence-type-sha256-f6e6eff1b7c19fa6b1ae6edb4a1ba6fb54fc3bbef69e231ba52ba814b1dc3869) |
...
| `coop` | not declared | none | [`{ kind: "coop" }`](#persistence-type-sha256-e32f39934f0d1a6e3cf28ff4016857db3b44a70711e0c4e410269b16026aeff9) |
...
Array of [`Message`](#persistence-type-sha256-89a9812450699683b42f6b44338741bd26726a8215a1aebe2c27e34e8e2617eb).
...
Sources: [`packages/coop/coop/src/types.ts:15`](../packages/coop/coop/src/types.ts)
...
Sources: [`packages/coop/coop/src/types.ts:6`](../packages/coop/coop/src/types.ts)
...
Array of [`Role`](#persistence-type-sha256-0db7b4821322f24c43d71ad9f20d602b80bb6f64a4eb9a00023f81d33541cc9c).
...
| `messageSeqs` | required | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `messages` | required | [`Message[]`](#persistence-type-sha256-b8fd0eaa916d10bf880f33e07a8b2d466b72a0170364a44c2781ea1360371173) |
...
Sources: [`packages/coop/coop/src/types.ts:169`](../packages/coop/coop/src/types.ts)
...
| `message` | required | [`DeveloperMessage`](#persistence-type-sha256-492f2aaac36391369e42d41eecfc86046779438526a57c5265db0bc1a6e259ce) |
| `step` | required | `number` |
| `turn` | required | `number` |
...
| Property | Presence | Type |
|---|---|---|
| `inserted` | required | [`UserMessage[]`](#persistence-type-sha256-6a0a18fb54eff45ffceefdc36cfa252cb2879bd80c53966868599147127efb17) |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`{ inserted, outcome?, removedCount?, start, … }`](#persistence-type-sha256-c52054a28bd31ec67ad95cc96744466f3f97b56023133ca61165fa7ea70e2af0) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`CoopExecutionEventData`](#persistence-type-sha256-f9145ef951a110eb594b0af7ccc4951f22e855790e1630814b5a10448dc9f1ba) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
| `type` | required | `"coop/execution"` |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`CoopPlanChangeEventData`](#persistence-type-sha256-3b5534b273cb048fe7edc1739d4b95c61d52c0f3366660c7e2c30c8f1e99f827) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
| `type` | required | `"coop/plan-change"` |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`CoopRegistryEventData`](#persistence-type-sha256-803e221974ea8c5f79e563a1bb271dab34b090464e731b4beae6a10e4cbbed8f) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`CoopReviewEventData`](#persistence-type-sha256-b90fb1ad3949cec37ff212e89b0f8a2a1cd70b01d0f975dde5e3d12f8401430c) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
| `type` | required | `"coop/review"` |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`{ headerSeq?, message, step, turn }`](#persistence-type-sha256-26184fe18d94008687bb36739c834d9e309bb25e1c936f165fc43b5b1b049158) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `sourceEventSeqs` | optional | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | required | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`SessionTitleLlmRequestEventData`](#persistence-type-sha256-1e9ef608735f2c534f58744fcd69b91e4d114a56859c6166cc22eff7384bffcc) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`UserMessage`](#persistence-type-sha256-bf8ecfb9c92f3b28f2327779328bcf0e6ae879504bc9f19238a3925f5bf4fe93) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `sourceEventSeqs` | optional | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | required | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
