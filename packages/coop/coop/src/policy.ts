...
export const COOP_POLICY_TEXT = [
  ...
  '- As worker, a passed pre-review is your execution trigger: chain `coop_execute_begin` → do the work → `coop_execute_report` without waiting for another wake (a `[coop] … approved for execution` message repeats this drive).',
